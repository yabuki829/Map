...
//        print("map呼ばれてますewfpowekfaowjf@pawjf@ipawj@fpoijwpi@gnw@oirgnearignwajr@oifjwepoifjawp@ijfpweijfpaiwjfpwijfwpeifjwpeifjwpi")
...
//
//                    CacheManager.shared.getFileWith(stringUrl: self.descriptionList![i].data.url) { result in
//                        switch result {
...
//                    }
//
////                    videoView.loadVideo(urlString: self.descriptionList![i].data.url) { result in
////                        if result {
////                            videoView.setup()
////                            videoView.setupVideoTap()
////                            if videoView.player != nil {
////                                self.videoArray.append(videoData(postId:self.descriptionList![i].id , player: <#T##AVPlayer#>))
////                                self.mapView.addAnnotation(annotation)
////                            }
////                        }
////                    }
